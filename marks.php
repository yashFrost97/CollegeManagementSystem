...
<div class="form-group">
	...
	<?php
		...
		?>
		<div class="form-group">
		<select name="MYsubj" class="form-control">
			<?php
		...
		<button class="btn btn-lg btn-danger btn-block" type="submit" name="myfeed"> <i class="fa fa-pen" aria-hidden="true">Go to marksheet</i></button>
	</form>
	</div>
	<?php
		if(isset($_POST['myfeed'])){
			$_SESSION['MYsubj']=$_POST['MYsubj'];
