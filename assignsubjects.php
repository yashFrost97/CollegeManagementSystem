...
<body>
	...
	<form action="assignsubjects.php" method="post">
	<?php
		...
		<button class="btn btn-lg btn-danger btn-block" type="submit" name="aupload"> <i class="fa fa-pen" aria-hidden="true"></i>Go to uploading Assignments</button>
	</form>
	</div>
	<!--Ends-->
...
<?php
	if(isset($_POST['aupload'])){
		$_SESSION['subject']=strtolower($_POST['subj']);
