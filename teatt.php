...
<body>
	...
	<?php
		...
		?>
		<div class="container" style="margin-top:10%; width: 75%; height:70%;" >
		<h3 class="text-center">YOUR ATTENDANCE IN PERCENTAGE TILL TODAY</h3><br>
		<table class="table table-striped table-bordered">
		<tr class="row">
			<th class="col-md-4 text-center">Roll No</th>
			<th class="col-md-2 text-center">SE</th>
			<th class="col-md-2 text-center">SPCC</th>
			<th class="col-md-2 text-center">DD</th>
			<th class="col-md-2 text-center">MCC</th>
		</tr>
		<?php
		$roll=$_SESSION['ID'];
		foreach($total as $col){
			?>
			<tr class="row">
			<td class="col-md-4 text-center"><h4><b><?php echo $roll ?></h4></b></td>
			<?php
				foreach($col as $def){
					if($def<75){
						?>	
							<td class="col-md-2 text-center" style="background:red;opacity:0.8;"><h4><b><?php echo round($def,2)?></h4></b></td>
						<?php
					}
				
					else{
						?>	
							<td class="col-md-2 text-center"><h4><b><?php echo round($def,2)?></h4></b></td>
						<?php
					}
				}
				$roll++;
