...
<body>
	...
	<form action="attendsubjects.php" method="post">
	<?php
		...
		<button class="btn btn-lg btn-danger btn-block" type="submit" name="submit"> <i class="fa fa-pen" aria-hidden="true"></i>Enter Attendance</button>
		</div>
	<form>
</html>
