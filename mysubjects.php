...
<body>
	...
	<form action="mysubjects.php" method="post">
	<?php
		...
		<button class="btn btn-lg btn-danger btn-block" type="submit" name="myfeed"> <i class="fa fa-pen" aria-hidden="true"></i>SEE FEEDBACK</button>
	</form>
	</div>
	<!--Ends-->
